...
rand_effect_matrix = mvrnorm(n, mu = mean_vector, Sigma = random_effects_cov)
...
data_raw$y = beta_0 + beta_1 * data_raw$x1 + beta_2 * data_raw$x2 + beta_3 * data_raw$x3 +  b_0i + b_1i * data_raw$x1 + b_2i * data_raw$x2 + b_3i * data_raw$x3 + beta_4 * data_raw$z1 + beta_5 * data_raw$z2 + beta_6 * data_raw$z3
